...
public class GUI extends JFrame implements ActionListener {
  ...
  public int[] TimePerFrame = new int[15];					//mehr als 15 frames wird ein user f�r ein video nicht brauchen
                ...
                if (!arg0.getValueIsAdjusting()) { 						//wenn der r�ckgabewert des events =true ist	
                	...
                	for (int i = 0; i <= 13; i++) {
						if (IndexInVideo[i+1]=true) {
							indexZaehler++;
							indexSammler[indexZaehler]=index+1;	//enth�lt alle index die ins video kommen m�ssen
						}
					}
...
*/               	  
      ...
      list.addMouseListener(new MouseAdapter() {								//frame l�sst sich per doppelklick "renamen"   in liste 1
          @SuppressWarnings("unchecked")
      ...
      list2.addMouseListener(new MouseAdapter() {								//frame l�sst sich per doppelklick "renamen"   in liste 2
          @SuppressWarnings("unchecked")
		public void mouseClicked(MouseEvent e) {
            if (e.getClickCount() == 2) {
